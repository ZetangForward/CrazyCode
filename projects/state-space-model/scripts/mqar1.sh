...
do
    ...
    do
        ...
        python evaluate/evaluator.py \
            --task AR_ywj \
            --fpath /public/home/ljt/tzc/evaluation/AR_ywj/mamba-1_4b/version_$JOB_ID/results/predictions.pkl \
            --save_evaluation_path /public/home/ljt/tzc/evaluation/AR_ywj/mamba-1_4b/version_$JOB_ID/results/eval.txt;
    done
done
