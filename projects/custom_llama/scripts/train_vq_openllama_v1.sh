...
deepspeed --num_gpus 4 \
    ...
    train_vqllama.py \
    --model_name_or_path "/zecheng2/vqllama/vqllama_openllama/version_1/checkpoint-3500" \
    --resume_from_checkpoint "/zecheng2/vqllama/vqllama_openllama/version_1/checkpoint-3500" \
