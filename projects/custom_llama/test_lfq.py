...
@hydra.main(config_path='./configs/experiment', config_name='config_test_lfq', version_base='1.1')
def main(config):
    ...
    lfq = LFQ(config, multipliers=None, **block_kwargs)
    experiment = Experiment(lfq, config)
